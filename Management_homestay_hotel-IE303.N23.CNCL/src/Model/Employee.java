...
public class Employee {
    ...
    public void insertEmployee(Employee emp)
    {
        try 
        {
            String update = "insert into employee (emp_name, shift, emp_phone, emp_address, emp_acc, emp_pass) values ('" +emp.getEmpName() + "', '" +emp.getShift()+ "', '" +emp.getEmpPhone()+ "', '" +emp.getEmpAddress()+ "', '" + emp.getEmpAccount()+ "', '" + emp.getEmpPassword()+ "');";
